...
export default function KeywordSearch({ value, onChange, disabled }: KeywordSearchProps) {
  return (
    <div className="mb-4">
      <label htmlFor="contact-search" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
        Search by keyword
      </label>
