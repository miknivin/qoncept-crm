...
export default function DateTimePickerUi({
  ...
  const renderCalendar = () => {
    ...
    for (let i = 1; i <= daysInMonth; i++) {
      ...
      if (selectedDate && dayString === selectedDate.split(" ")[0]) {
  ...
  const handleDayClick = (selectedDay: Date) => {
    ...
    setSelectedDate(`${dayString} ${selectedTime} ${period}`);
  };
  ...
  const handleTimeChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (selectedDate) {
      ...
      setSelectedDate(`${datePart} ${newTime} ${period}`);
    }
  };
  ...
  const handlePeriodChange = (newPeriod: "AM" | "PM") => {
    ...
    if (selectedDate) {
      const datePart = selectedDate.split(" ")[0];
      setSelectedDate(`${datePart} ${selectedTime} ${newPeriod}`);
    }
  };

  const updateInput = () => {
    return selectedDate || placeholder;
  };
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex">
            ...
            <div className="w-32 border-l border-gray-300 dark:border-gray-600 p-5">
              ...
              <input
                ...
                className="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              />
              <div className="mt-2 flex space-x-2">
                <button
                  type="button"
                  role="button"
                  className={`flex-1 py-1 text-sm font-medium rounded-lg ${
                    period === "AM"
          ...
          <div className="mt-4 flex justify-end space-x-2.5 border-t border-gray-300 dark:border-gray-600 p-5">
            <button
              type="button"
              role="button"
